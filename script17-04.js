...
// ARROW FUNCTION         ( if sinle line toh direct likh do nahi toh return use krna hi padega )
...
// IIFE   (immediately invoked fxn)         jis order me likha hai vaise hi print hote jayenge 
// syntax
// (function(){
//     console.log("iife");
// })();
...
// (()=>{                                               // defin + calling saath me hjoga toh order change nahi kr skte as normal fxn     //use () to invoke the fxn 
...
// RECURSION FXN   (application of stack = LIFO)
...
//     console.log("end");
// }
// console.log("ended",nr);               // yeh stack me jayega fir recusrion khtm hoga tab aayega yeh
// }

// getRecursion(3);


// PERFORMANCE OF ITERATION USING LOOP IS FASTR THAN RECURSION AS RECURSION USES PUSH POP BUT RECUSRION  IF EASY TO USE WITH SAMLLER CODE 
...
// NESTED FXN = fxn defined inside another fxn 

// function doOuterFxn(nr){
//     console.log("outer");
//     doInnerfxn(nr);
//     function doInnerfxn(x){
//         console.log(x+7);
//         console.log("can access ourter variable", nr);          // nr = outer fxn visible everywhere
//     }
//     console.log("cant access inner variable", x);
// }



// FUNCTION CALLBACKS = fxn as an argument kisi aur fxn me call hota hai 
...
// function doFlexiable(executeStuff){
//     executeStuff();
//     console.log("inside doflexibkle fxn");
// }
...
//setTimeOut() = delays after a specified amount of time 
// let youGotThs = function(){
//     console.log("keep gping");
// };

// setTimeout(youGotThs, 5000);            /// going to wait for 1000 ms or 1 sec then print

// setInterval(youGotThs,1000);            // 1000 interval ke baad baar baar chalega 
